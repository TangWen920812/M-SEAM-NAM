...
class singleNet(nn.Module):
    def __init__(self):
        ...
        num = 1
        self.num = num
        self.conv1a = nn.Conv2d(3, 64//num, 3, padding=1, bias=False)

        self.b2 = ResBlock(64//num, 128//num, 128//num, stride=2)
        self.b2_1 = ResBlock(128//num, 128//num, 128//num)
        self.b2_2 = ResBlock(128//num, 128//num, 128//num)

        self.b3 = ResBlock(128//num, 256//num, 256//num, stride=2)
        self.b3_1 = ResBlock(256//num, 256//num, 256//num)
        self.b3_2 = ResBlock(256//num, 256//num, 256//num)

        self.b4 = ResBlock(256//num, 512//num, 512//num, stride=2)
        self.b4_1 = ResBlock(512//num, 512//num, 512//num)
        self.b4_2 = ResBlock(512//num, 512//num, 512//num)
        self.b4_3 = ResBlock(512//num, 512//num, 512//num)
        self.b4_4 = ResBlock(512//num, 512//num, 512//num)
        self.b4_5 = ResBlock(512//num, 512//num, 512//num)

        self.b5 = ResBlock(512//num, 512//num, 1024//num, stride=1, first_dilation=1, dilation=2)
        self.b5_1 = ResBlock(1024//num, 512//num, 1024//num, dilation=2)
        self.b5_2 = ResBlock(1024//num, 512//num, 1024//num, dilation=2)

        self.b6 = ResBlock_bot(1024//num, 2048//num, stride=1, dilation=4, dropout=0.3)

        self.b7 = ResBlock_bot(2048//num, 4096//num, dilation=4, dropout=0.5)

        self.bn7 = nn.BatchNorm2d(4096//num)
...
class multiNet(nn.Module):
    ...
    def forward_as_dict(self, x):
        ...
        for i in range(self.num):
            d = self.models[i].forward_as_dict(x)
            conv3.append(d['conv3'])
            conv4.append(d['conv4'])
            conv5.append(d['conv5'])
            conv6.append(d['conv6'])
